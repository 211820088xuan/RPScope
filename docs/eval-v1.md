...
|---|---|---|---|---|---|---|---|
| strict (全部 gold(含上下游+other)) | 6673 | 14.9% | 1.5% | 2.7% | 100 | 571 | 6573 |
| comparable (仅系统能力内(upstream)) | 2601 | 8.0% | 2.1% | 3.3% | 54 | 617 | 2547 |
| capability_out (仅系统能力外(downstream)) | 1402 | 1.0% | 0.5% | 0.7% | 7 | 664 | 1395 |

### 可比口径(主指标)说明
- **可比口径 precision = 8.0%**: 系统 matched 54 / 系统候选 671
